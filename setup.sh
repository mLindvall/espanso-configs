...
# pulled from https://github.com/Lissy93/espanso-config/blob/master/setup.sh

# modified by mlindvall
# modified on 08/25/2023
...
make_link() {
  ...
  cp -rs "${ESPANSO_SRC_PATH}"/*.yml "${ESPANSO_DEST_PATH}"/
  exit 1
}
